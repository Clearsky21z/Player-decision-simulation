...
def _batch_to_tensors(
    ...
    return channels, dest, actor_ids, context, completed
...
def main():
    ...
    for ep in range(args.epochs):
        ...
        for batch in train_dl:
            ...
            channels, dest, actor_ids, context, completed = _batch_to_tensors(
                batch2, player_id_mapping, args.device
            )
            logits = model(channels, actor_ids, context)
            loss = pass_success_loss(logits, dest, completed)
